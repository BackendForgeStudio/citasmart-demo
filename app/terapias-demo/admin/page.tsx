...
export default function TerapiasAdminDashboard() {
  ...
  return (
    <main className="min-h-screen bg-[#FDFCFB] font-sans text-stone-800 z-0 flex flex-col">
      ...
      {/* CABECERA */}
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-stone-200 px-6 py-4 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-6">
          <Link href="/terapias-demo" className="inline-flex items-center gap-2 bg-[#FDFCFB] px-5 py-2.5 rounded-full text-[10px] font-bold uppercase tracking-widest text-stone-700 shadow-sm border border-stone-200 hover:border-stone-900 transition-all">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="bg-stone-900 px-5 py-2.5 rounded-full text-[10px] font-bold uppercase tracking-widest text-white border border-stone-900 flex items-center gap-2 shadow-md">
            <ShieldCheck strokeWidth={1.5} className="w-4 h-4 text-[#D4AF37]" /> PIN de Seguridad Activo
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 p-4 md:p-10 max-w-[1400px] mx-auto w-full relative z-10 space-y-8">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-[2rem] shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-stone-200 overflow-hidden">
          <div className="p-6 md:p-8 border-b border-stone-200 flex justify-between items-center bg-[#FDFCFB]">
            ...
            <span className="text-xs font-bold uppercase tracking-widest bg-stone-900 text-white px-4 py-2 rounded-full shadow-sm">
              Vista Clínica
            </span>
          </div>
